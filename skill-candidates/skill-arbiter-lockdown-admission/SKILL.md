...
6. Reject or repair candidates that still encode legacy `Documents\GitHub` roots instead of canonical `G:\GitHub`, or that treat direct LM Studio `:1234` as anything other than model authority or MX3 `:9000` as anything other than non-model support.
